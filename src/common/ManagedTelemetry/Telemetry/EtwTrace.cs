...
namespace Microsoft.PowerToys.Telemetry
{
    ...
    public class ETWTrace : IDisposable
    {
        ...
        private string etwFolderPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Kit", "etw");
...
#nullable disable
        ...
        public void Start()
        {
            lock (this)
            {
                if (!this.telemetryEnabled || !this.telemetryRecordingEnabled || this.started)
                {
                    return;
                }
