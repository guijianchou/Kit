...
namespace Microsoft.PowerToys.Settings.UI.Helpers
{
    ...
    {
        private static string _placementPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Kit", "settings-placement.json");
