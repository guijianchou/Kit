...
namespace Kit.Settings.UI.Library
{
    ...
    /// </summary>
    /// <remarks>
    /// <para><strong>âš ï¸ CRITICAL REQUIREMENT FOR ALL NEW SETTINGS CLASSES âš ï¸</strong></para>
    /// <para>
    ...
    /// </list>
    /// <para><strong>âš ï¸ Failure to register types will cause runtime errors:</strong></para>
    /// <para>
    ...
    // Properties Classes
    [JsonSerializable(typeof(AIHubProperties))]
