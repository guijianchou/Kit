...
namespace kit_gpo
{
    ...
    inline gpo_rule_configured_t getConfiguredValue(const std::wstring&)
    {
        // Keep the native/WinRT contract used by imported modules without
        // applying another product's policies to Kit.
