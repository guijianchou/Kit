...
namespace
{
    constexpr inline wchar_t KIT_MSI_MUTEX_NAME[] = L"Local\\Kit_Runner_MSI_InstanceMutex";
    constexpr inline wchar_t KIT_BOOTSTRAPPER_MUTEX_NAME[] = L"Local\\Kit_Bootstrapper_InstanceMutex";
}
