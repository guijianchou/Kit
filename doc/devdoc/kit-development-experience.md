...
- The inactive AdvancedPaste-only `LanguageModelProvider` source tree was deleted instead of only being removed from build graphs. Its AI provider package pins and stale `OpenAI` third-party notice entry were removed with it.
