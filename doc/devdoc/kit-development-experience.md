...
- `UITestAutomation` keeps the shared Light Switch UI-test infrastructure but no longer carries inactive FancyZones, Hosts, Workspaces, PowerRename, Command Palette, or Screen Ruler launch targets and cleanup branches.
