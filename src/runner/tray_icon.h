...
// Must be the same as: settings-ui/Settings.UI/Views/ShellPage.xaml.cs -> CloseDialog_Click() -> const string kitTrayIconWindowClass
const inline wchar_t* pt_tray_icon_window_class = L"KitTrayIconWindow";
