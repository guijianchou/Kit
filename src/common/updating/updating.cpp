...
{
    const wchar_t LATEST_RELEASE_ENDPOINT[] = L"https://api.github.com/repos/guijianchou/Kit/releases/latest";
    const wchar_t ALL_RELEASES_ENDPOINT[] = L"https://api.github.com/repos/guijianchou/Kit/releases";
