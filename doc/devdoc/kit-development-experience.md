...
- Backup/restore defaults were pruned to generic active Kit settings rules by deleting inactive Keyboard Manager, FancyZones, Workspaces, and PowerToys Run restore entries.
