...
namespace Microsoft.PowerToys.Settings.UI.Library
{
    public class SettingPath
    {
        ...
        private const string KitAppDataFolder = "Kit";
        ...
        {
            return _directory.Exists(System.IO.Path.Combine(Helper.LocalApplicationDataFolder(), KitAppDataFolder, powertoy));
        }

        public void CreateSettingsFolder(string powertoy)
        {
            _directory.CreateDirectory(System.IO.Path.Combine(Helper.LocalApplicationDataFolder(), KitAppDataFolder, powertoy));
        }

        public void DeleteSettings(string powertoy = "")
        {
            _directory.Delete(System.IO.Path.Combine(Helper.LocalApplicationDataFolder(), KitAppDataFolder, powertoy));
        }
