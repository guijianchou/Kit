...
namespace PowerDisplay.Common
{
    ...
    public static class PathConstants
    {
        ...
        private static readonly Lazy<string> _kitBasePath = new Lazy<string>(
            () => Path.Combine(_localAppDataPath.Value, "Kit"));

        /// <summary>
        /// Gets the base Kit settings folder path.
        /// Example: C:\Users\{User}\AppData\Local\Kit
        /// </summary>
        public static string KitBasePath => _kitBasePath.Value;

        /// <summary>
        /// Gets the PowerDisplay module folder path.
        /// Example: C:\Users\{User}\AppData\Local\Kit\PowerDisplay
        /// </summary>
        public static string PowerDisplayFolderPath => Path.Combine(KitBasePath, "PowerDisplay");

        /// <summary>
        /// Gets the PowerDisplay profiles file path.
        /// Example: C:\Users\{User}\AppData\Local\Kit\PowerDisplay\profiles.json
        /// </summary>
        ...
        /// Example: C:\Users\{User}\AppData\Local\Kit\PowerDisplay\settings.json
        /// </summary>
        ...
        /// Example: C:\Users\{User}\AppData\Local\Kit\LightSwitch
        /// </summary>
        public static string LightSwitchFolderPath => Path.Combine(KitBasePath, "LightSwitch");

        /// <summary>
        /// Gets the LightSwitch settings file path.
        /// Example: C:\Users\{User}\AppData\Local\Kit\LightSwitch\settings.json
        /// </summary>
        ...
        /// Example: C:\Users\{User}\AppData\Local\Kit\PowerDisplay\monitor_state.json
        /// </summary>
        ...
        /// </summary>
        public const string LightSwitchLightThemeEventName = "Local\\KitLightSwitch-LightThemeEvent-50077121-2ffc-4841-9c86-ab1bd3f9baca";
        ...
        /// </summary>
        public const string LightSwitchDarkThemeEventName = "Local\\KitLightSwitch-DarkThemeEvent-b3a835c0-eaa2-49b0-b8eb-f793e3df3368";
